...
get_nome_logo() {
  ...
  print_banner
  printf "${WHITE} 💻 Digite a LOGOMARCA da empresa que ficará no painel; Ex: OwenZap | Automação para Whatsapp ${GRAY_LIGHT}"
  printf "\n\n"
  read -p "> " nome_logo
}
...
get_cor_logo() {
  ...
  print_banner
  printf "${WHITE} 💻 Digite o CODIGO da COR que ficará no painel; Ex: #044842 (Verde) ${GRAY_LIGHT}"
  printf "\n\n"
  read -p "> " cor_logo
}
