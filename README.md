...
```bash
cd && rm -rf wa-install && git clone https://github.com/pgdigital/pgdigital/super-install.git && sudo chmod -R 777 ./wa-install && cd ./super-install && sudo ./install_instancia
